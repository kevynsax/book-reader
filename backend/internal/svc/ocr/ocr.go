...
var verifyTranscriptPrompt = strings.Join([]string{
	...
	"(3) numbers, dates, and references read out in words (\"Gen 39:2\" heard as \"genesis chapter thirty nine verse two\") — that is the correct spoken form;",
	"(4) capitalization, accents, filler differences, or minor word substitutions that keep the meaning.",
	"If every clause of the text has SOME corresponding spoken material in the transcript, missing is false — even when many individual words differ.",
