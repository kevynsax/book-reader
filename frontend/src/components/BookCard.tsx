...
const STATUS_LABEL: Record<BookStatus, string> = {
  ...
  generating_sentences: t('Splitting sentences'),
  awaiting_sentence_review: t('Sentences to review'),
...
const STATUS_CLASS: Record<BookStatus, string> = {
  ...
  generating_sentences: 'badge-processing',
  awaiting_sentence_review: 'badge-review',
