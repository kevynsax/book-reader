...
import { updatePageText, reocrPage } from '../store/booksSlice';
      ...
      {fullscreen && createPortal(
        <div className="fixed inset-0 z-50 h-[100dvh] w-screen bg-gray-950 flex flex-col">
          <div className="relative flex items-center gap-4 px-6 py-4 border-b border-gray-800 shrink-0">
            ...
            <button
              className="h-7 px-2 rounded flex items-center gap-1.5 text-xs text-gray-400 hover:text-gray-200 hover:bg-gray-800 disabled:opacity-40 transition-colors shrink-0"
